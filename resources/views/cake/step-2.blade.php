...
<head>
    ...
    <title>Birthday Cake — Step 2: :has()</title>
    @vite(['resources/css/cake-step-2.css'])
</head>
...
<body>
    ...
    <div class="info">
        <h2>Step 2 — :has() Selector</h2>
        <ul>
            <li><strong>:has()</strong> detects checkbox state</li>
            <li>Flame hides, confetti fires — zero JS</li>
            <li>Button text swaps via CSS</li>
            <li>Confetti colors driven by custom properties</li>
        </ul>
        <p class="hint">Click "Blow out candle" to trigger confetti!</p>
    </div>
