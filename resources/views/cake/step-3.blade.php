...
<head>
    ...
    <title>Birthday Cake — Step 3: clamp()</title>
    @vite(['resources/css/cake-step-3.css'])
</head>
...
<body>
    ...
    <div class="info">
        <h2>Step 3 — clamp() & Fluid Sizing</h2>
        <ul>
            <li><strong>clamp()</strong> for cake width/height</li>
            <li>Fluid font sizes on info box text</li>
            <li><strong>min()</strong>/<strong>max()</strong> for spacing</li>
            <li>Cake scales smoothly across viewport sizes</li>
        </ul>
        <p class="hint">Resize the browser to see the cake scale fluidly.</p>
    </div>
