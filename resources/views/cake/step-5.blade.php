...
<head>
    ...
    <title>Birthday Cake — Step 5: Anchor Positioning</title>
    @vite(['resources/css/cake-step-5.css'])
</head>
...
<body>
    ...
    <div class="cake-scene">
        <div class="info">
            <h2>Step 5 — Anchor Positioning</h2>
            <ul>
                <li><strong>anchor-name: --candle</strong> on the candle</li>
                <li>Button anchored to candle — no hardcoded offsets</li>
                <li>Info panel anchored to the cake</li>
                <li>Declarative attachment replaces positioning math</li>
            </ul>
            <p class="hint">All 5 modern CSS features in one component!</p>
        </div>
