    ...
    <main class="demo-tabs max-w-5xl mx-auto">
        ...
        <div class="demo-content bg-surface border border-border border-t-0 rounded-b-xl p-6">
            ...
            <section class="demo-section demo-has">
                ...
                <p class="text-text-muted mb-6 text-sm">Style a parent based on its children's state — no JavaScript
                    required.</p>
                ...
                <div class="grid md:grid-cols-2 gap-6 mb-8">
                    ...
                    <div class="panel">
                        ...
                        <div class="panel-body bg-surface-alt">
                            <p class="text-sm text-text-muted mb-3">Click the checkbox — JS toggles <code
                                    class="bg-code-bg text-code-text px-1 rounded text-xs">.is-selected</code> on the
                                parent card.</p>
                    ...
                    <div class="panel">
                        ...
                        <div class="panel-body bg-surface-alt">
                            <p class="text-sm text-text-muted mb-3">Same result — zero JavaScript. CSS detects the
                                checked child.</p>
                ...
                <div class="grid md:grid-cols-2 gap-6">
                    ...
                    <div class="panel">
                        <div class="panel-header before">Before — JavaScript</div>
                        <div class="panel-body bg-surface-alt">
                            <p class="text-sm text-text-muted mb-3">JS listens for clicks, loops items, toggles classes
                                to show/hide matches.</p>
                    ...
                    <div class="panel">
                        <div class="panel-header after">After — Pure CSS :has()</div>
                        <div class="panel-body bg-surface-alt">
                            <p class="text-sm text-text-muted mb-3">Click a filter — <code
                                    class="bg-code-bg text-code-text px-1 rounded text-xs">:has()</code> detects which
                                radio is checked and dims non-matching items.</p>
            ...
            <section class="demo-section demo-container">
                ...
                <p class="text-text-muted mb-6 text-sm">Components adapt to their container's width, not the viewport.
                </p>
                ...
                <div class="grid md:grid-cols-2 gap-6">
                    ...
                    <div class="panel">
                        ...
                        <div class="panel-body bg-surface-alt">
                            <p class="text-sm text-text-muted mb-3">Cards only respond to the viewport width — useless
                                inside a sidebar.</p>

                            <div class="cq-before-grid">
                                <div class="cq-before-card"><strong>Card A</strong>
                                    <p class="text-sm text-text-muted mt-1">Always same layout</p>
                                </div>
                                <div class="cq-before-card"><strong>Card B</strong>
                                    <p class="text-sm text-text-muted mt-1">regardless of parent</p>
                                </div>
                            </div>
                        ...
                        <div class="panel-body bg-surface-alt">
                            ...
                            <div class="resizable-wrapper cq-container" style="width: 100%;">
                                <div class="cq-after-grid">
                                    <div class="cq-after-card"><strong>Card A</strong>
                                        <p class="text-sm text-text-muted mt-1">Adapts to container</p>
                                    </div>
                                    <div class="cq-after-card"><strong>Card B</strong>
                                        <p class="text-sm text-text-muted mt-1">Not viewport!</p>
                                    </div>
                                    <div class="cq-after-card"><strong>Card C</strong>
                                        <p class="text-sm text-text-muted mt-1">Drag to resize →</p>
                                    </div>
                                </div>
                            </div>
            ...
            <section class="demo-section demo-anchor">
                ...
                <p class="text-text-muted mb-6 text-sm">Attach elements to other elements declaratively — no offset
                    math needed.</p>
                ...
                <div class="grid md:grid-cols-2 gap-6 mb-8">
                    ...
                    <div class="panel">
                        ...
                        <div class="panel-body bg-surface-alt">
                            <p class="text-sm text-text-muted mb-4">Tooltip requires a wrapper, <code
                                    class="bg-code-bg text-code-text px-1 rounded text-xs">position: relative</code>,
                                and hardcoded offsets.</p>

                            <div class="flex justify-center py-8">
                                <div class="anchor-before-wrapper">
                                    <button
                                        class="px-4 py-2 bg-accent text-white rounded-lg font-medium hover:opacity-90 transition-opacity">
                                        Hover me
                                    </button>
                    ...
                    <div class="panel">
                        ...
                        <div class="panel-body bg-surface-alt">
                            <p class="text-sm text-text-muted mb-4">No wrapper needed. The tooltip finds its anchor by
                                name.</p>

                            <div class="flex justify-center py-8">
                                <button
                                    class="anchor-trigger px-4 py-2 bg-accent text-white rounded-lg font-medium hover:opacity-90 transition-opacity">
                                    Hover me
                                </button>
                ...
                <div class="grid md:grid-cols-2 gap-6">
                    ...
                    <div class="panel">
                        ...
                        <div class="panel-body bg-surface-alt">
                            <p class="text-sm text-text-muted mb-4">JS to toggle visibility, a wrapper for positioning,
                                and manual offset calc.</p>

                            <div class="flex justify-center py-6">
                                <div class="popover-before-wrapper">
                                    <button id="popover-before-btn"
                                        class="px-4 py-2 bg-accent text-white rounded-lg font-medium hover:opacity-90 transition-opacity">
                                        Actions ▾
                                    </button>
                                    <div id="popover-before-menu" class="popover-before-menu">
                                        ...
                                        <a href="#"
                                            class="popover-menu-item popover-menu-item--danger">Delete</a>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="panel">
                        ...
                        <div class="panel-body bg-surface-alt">
                            <p class="text-sm text-text-muted mb-4">The Popover API handles open/close & light-dismiss.
                                Anchor positioning handles placement. Zero JS.</p>

                            <div class="flex justify-center py-6">
                                <button
                                    class="popover-anchor-trigger px-4 py-2 bg-accent text-white rounded-lg font-medium hover:opacity-90 transition-opacity"
                                    popovertarget="popover-after-menu">
                                    Actions ▾
                                </button>
                ...
                <p class="text-xs text-text-muted mt-4 italic">Note: Anchor Positioning is supported in Chrome/Edge.
                    Firefox & Safari support is in progress.</p>
            </section>

            {{-- ===== 4. clamp() ===== --}}
            <section class="demo-section demo-clamp">
                <h2 class="text-xl font-bold mb-1">clamp() & CSS Value Functions</h2>
                <p class="text-text-muted mb-6 text-sm">Fluid typography and spacing in a single line — no breakpoints
                    required.</p>
                ...
                <div class="grid md:grid-cols-2 gap-6">
                    ...
                    <div class="panel">
                        ...
                        <div class="panel-body bg-surface-alt">
                            ...
                            <p class="clamp-before-text">This text jumps between fixed sizes at specific breakpoints.
                                Resize the window to see the steps.</p>
                    ...
                    <div class="panel">
                        ...
                        <div class="panel-body bg-surface-alt">
                            ...
                            <p class="clamp-after-text">This text scales smoothly between min and max. One line does
                                the work of four media queries.</p>
            ...
            <section class="demo-section demo-lightdark">
                ...
                <p class="text-text-muted mb-6 text-sm">One declaration per property instead of duplicated media query
                    blocks.</p>
                ...
                <div class="grid md:grid-cols-2 gap-6">
                    ...
                    <div class="panel">
                        ...
                        <div class="panel-body bg-surface-alt">
                            <p class="text-sm text-text-muted mb-3">Every property needs a duplicate inside <code
                                    class="bg-code-bg text-code-text px-1 rounded text-xs">@media
                                    (prefers-color-scheme: dark)</code>.</p>
                            ...
                            <div class="grid grid-cols-2 gap-3 mb-4">
                                <div>
                                    ...
                                    <div class="bg-white text-gray-900 border border-gray-200 p-3 rounded-lg">
                                        <span
                                            class="inline-block bg-gray-100 text-gray-600 px-2 py-0.5 rounded text-xs font-medium mb-1">Badge</span>
                                ...
                                <div>
                                    ...
                                    <div class="bg-[#1a1a2e] text-gray-200 border border-[#333355] p-3 rounded-lg">
                                        <span
                                            class="inline-block bg-[#2a2a4e] text-[#b0b0d0] px-2 py-0.5 rounded text-xs font-medium mb-1">Badge</span>
                                        <p class="text-sm">Card content</p>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="panel">
                        ...
                        <div class="panel-body bg-surface-alt">
                            <p class="text-sm text-text-muted mb-3">Toggle the scheme to see both modes — one
                                declaration handles both.</p>

                            <div class="flex gap-2 mb-4">
                                <button
                                    onclick="document.getElementById('ld-demo').className='ld-after-area force-light'"
                                    class="px-3 py-1 text-sm bg-white border border-border rounded-lg hover:bg-surface-alt transition-colors">Light</button>
                                <button
                                    onclick="document.getElementById('ld-demo').className='ld-after-area force-dark'"
                                    class="px-3 py-1 text-sm bg-code-bg text-code-text border border-border rounded-lg hover:opacity-80 transition-opacity">Dark</button>
                            </div>

                            <div id="ld-demo" class="ld-after-area force-light">
                                <div class="ld-after-card">
                                    <span
                                        class="badge inline-block px-2 py-0.5 rounded text-xs font-medium mb-1">Badge</span>
                                    <p class="text-sm">Card content</p>
                                </div>
                            </div>
    ...
    <script>
        ...
        if (jsFilter) {
            jsFilter.querySelectorAll('.filter-before-btn').forEach(btn => {
                btn.addEventListener('click', () => {
                    jsFilter.querySelectorAll('.filter-before-btn').forEach(b => b.classList.remove(
                        'active'));
                    btn.classList.add('active');
                    const filter = btn.dataset.filter;
                    jsFilter.querySelectorAll('.filter-before-tag').forEach(tag => {
                        tag.classList.toggle('dimmed', filter !== 'all' && tag.dataset.tag !==
                            filter);
                    });
                });
            });
